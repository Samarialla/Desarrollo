    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
               ...
               <a  class="btn btn-link" href="{{route('login') }}" ><h2><-Atras|Registro</h2></a>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input  type="text"  class="form-control @error('telefono') is-invalid @enderror"  name ='telefono'value="" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input  type="date" class="form-control @error('fecha_nac') is-invalid @enderror" name="fecha_nac"  required>
                            </div>
